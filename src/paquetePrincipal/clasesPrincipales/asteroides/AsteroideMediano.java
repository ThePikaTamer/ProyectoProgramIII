...
public class AsteroideMediano extends Asteroide {
	...
	protected static BufferedImage IMG = Assets.asteroideBasico1;
	...
	private final static Puntuacion PUNT = new Puntuacion(250);
	
	public AsteroideMediano(Asteroide asteroide) {
