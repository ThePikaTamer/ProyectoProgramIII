...
public class Main {
	...
	public static void main(String[] args) {
		...
		gb.partidasDeJuegoParaActualizar.add(new Partida(993492, "2022-12-17", LocalTime.now(), 100000,new Usuario(9999, "Juan", "Juan@gmail.com", "2000-10-23") , null));
		gb.partidasDeJuegoParaActualizar.add(new Partida(133545, "2022-12-10", LocalTime.now(), 102234,new Usuario(9999, "Juan", "Juan@gmail.com", "2000-10-23") , new Usuario(8888, "Maria", "Marybol@gmail.com", "2001-01-04")));
